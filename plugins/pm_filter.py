...
async def next_page(bot, query):
    ...
    try:
        if settings['auto_delete']:
            btn.insert(0, 
            [
                InlineKeyboardButton(f'🚦 𝑰𝒏𝒇𝒐', 'tips'),
                InlineKeyboardButton(f'🥤 𝑻𝒊𝒑𝒔', 'info')
            ]
            )
    ...
    try:
        ...
        if settings['max_btn']:
            ...
            if n_offset == 0:
                ...
                btn.append([InlineKeyboardButton("🌺𝙿𝙰𝙶𝙴𝚂", callback_data="pages"), InlineKeyboardButton(f"{math.ceil(int(offset)/10)+1} / {math.ceil(total/10)}", callback_data="pages"), InlineKeyboardButton("NEXT ➤▸️️", callback_data=f"next_{req}_{key}_{n_offset}")])
            else:
                btn.append(
                    [
                        InlineKeyboardButton("⛵ BACK", callback_data=f"next_{req}_{key}_{off_set}"),
                        InlineKeyboardButton(f"{math.ceil(int(offset)/10)+1} / {math.ceil(total/10)}", callback_data="pages"),
                        InlineKeyboardButton("NEXT ➤▸️️", callback_data=f"next_{req}_{key}_{n_offset}")
                    ],
                )
        else:
            ...
            if n_offset == 0:
                ...
                btn.append([InlineKeyboardButton("🌺𝙿𝙰𝙶𝙴𝚂", callback_data="pages"), InlineKeyboardButton(f"{math.ceil(int(offset)/int(MAX_B_TN))+1} / {math.ceil(total/int(MAX_B_TN))}", callback_data="pages"), InlineKeyboardButton("NEXT ➤▸️️", callback_data=f"next_{req}_{key}_{n_offset}")])
            else:
                btn.append(
                    [
                        InlineKeyboardButton("⛵ BACK", callback_data=f"next_{req}_{key}_{off_set}"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('❈𝑻𝒆𝒂𝒎 𝑹𝑹❈️', url="https://t.me/RhythmRockerz") ] ] ))
                else:
                    await query.answer(f"𝖧𝖾𝗒 {query.from_user.first_name}, 𝖳𝗁𝗂𝗌 𝗂𝗌 𝗇𝗈𝗍 𝗒𝗈𝗎𝗋 𝗋𝖾𝗊𝗎𝖾𝗌𝗍 !", show_alert=True)
                await query.answer('𝑪𝒉𝒆𝒄𝒌 𝑷𝑴 😊, 𝑰 𝒉𝒂𝒗𝒆 ➻ 𝒔𝒆𝒏𝒕 𝒇𝒊𝒍𝒆𝒔 𝒊𝒏 𝒑𝒎 🥳', show_alert=True)
        ...
        settings = await get_settings(grp_id)
        btn2 = [[
                 InlineKeyboardButton("►𝑪𝒉𝒆𝒄𝒌 𝑷𝑴◄", url=f"t.me/{temp.U_NAME}")
               ]]
        ...
        await query.answer("<u>𝗥𝗲𝗾𝘂𝗲𝘀𝘁𝘀 𝗙𝗼𝗿𝗺𝗮𝘁𝘀</u>\n\n❖ Petta 2019\n❖ Mr & Mrs arjun 2021\n❖ Gatta Kusthi 2022❖ Padayappa 1999\n❖ 7aum Arivu 2011.\n\n‼️𝗗𝗼𝗻𝘁 𝗮𝗱𝗱 𝘄𝗼𝗿𝗱𝘀 & 𝘀𝘆𝗺𝗯𝗼𝗹𝘀 𝗹𝗶𝗸𝗲 , . -  send link movie series 𝗲𝘁𝗰‼️", True)
    
    elif query.data == 'tips':
        await query.answer("𝖳𝗁𝗂𝗌 𝖬𝖾𝗌𝗌𝖺𝗀𝖾 𝖶𝗂𝗅𝗅 𝖡𝖾 𝖣𝖾𝗅𝖾𝗍𝖾𝖽 𝖠𝖿𝗍𝖾𝗋 5 𝖬𝗂𝗇𝗎𝗍𝖾𝗌 𝗍𝗈 𝖯𝗋𝖾𝗏𝖾𝗇𝗍 𝖢𝗈𝗉𝗒𝗋𝗂𝗀𝗁𝗍 !\n\n𝖳𝗁𝖺𝗇𝗄 𝖸𝗈𝗎 𝖥𝗈𝗋 𝖴𝗌𝗂𝗇𝗀 𝖬𝖾 😊\n\n\n𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 𝕽𝖍𝖞𝖙𝖍𝖒 𝕽𝖔𝖈𝖐𝖊𝖗𝖟🌷", True)

    elif query.data == "start":
        buttons = [[
                    InlineKeyboardButton('🌷𝕽𝓱𝔂𝓽𝓱𝓶 ℝ𝓸𝓬𝓴𝓮𝓻𝔃 🦚', url=f'https://t.me/RhythmRockerz')
                 ],[
            InlineKeyboardButton('📜 𝙃𝙚𝙡𝙥🕊 ️', callback_data='help'),
            InlineKeyboardButton('🧾️ 𝘼𝙗𝙤𝙪𝙩 🍀️', callback_data='about')
                 ],[
            InlineKeyboardButton('𝘾𝙧𝙚𝙖𝙩𝙤𝙧😎', url=f'https://t.me/RyanRR_Bot')
                 ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("📞 𝖢𝗈𝗇𝗍𝖺𝖼𝗍", url="t.me/RhythmRockerz")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        try:
            ...
            if settings['max_btn']:
                btn.append(
                    [InlineKeyboardButton("🌺𝙿𝙰𝙶𝙴𝚂", callback_data="pages"), InlineKeyboardButton(text=f"1/{math.ceil(int(total_results)/10)}",callback_data="pages"), InlineKeyboardButton(text="NEXT ➤▸️",callback_data=f"next_{req}_{key}_{offset}")]
                )
            else:
                btn.append(
                    [InlineKeyboardButton("🌺𝙿𝙰𝙶𝙴𝚂", callback_data="pages"), InlineKeyboardButton(text=f"1/{math.ceil(int(total_results)/int(MAX_B_TN))}",callback_data="pages"), InlineKeyboardButton(text="NEXT ➤▸️️",callback_data=f"next_{req}_{key}_{offset}")]
                )
        except KeyError:
