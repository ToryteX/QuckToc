...
🙋🏻‍♂️ 𝖳𝗎𝗍𝗈𝗋𝗂𝖺𝗅 𝖦𝗎𝗂𝖽𝖾 @RhythmRockerz
...
😎 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖻𝗒 <a href=https://t.me/RyanRR_Bot>⚜ Ʀ γ α и ⚜</a>"""

    ABOUT_TXT = """╭────[ 𝐀𝐛𝐨𝐮𝐭 𝐌𝐞𝐡 ]────⍟
│
├⍟ 𝑴𝒆𝒉 𝑵𝒂𝒎𝒆 : {}
│
├⍟ 𝑶𝒘𝒏𝒆𝒓 : <a href=https://t.me/RyanRR_Bot>⚜ Ʀ γ α и ⚜</a>
│
├⍟ 𝑽𝒆𝒓𝒔𝒊𝒐𝒏 : 𝟷.𝟸.𝟶 [ 𝐵𝑒𝑡𝑎 ]
│
├⍟ 𝑺𝒆𝒓𝒗𝒆𝒓 : 𝑉𝑃𝑆
│
├⍟ 𝑳𝒂𝒏𝒈𝒖𝒂𝒈𝒆 : 𝑃𝑦𝑡𝒉𝑜𝑛 𝟹.𝟷𝟶.𝟻
│
├⍟ 𝑭𝒓𝒂𝒎𝒆𝒘𝒐𝒓𝒌 : 𝑃𝑦𝑟𝑜𝑔𝑟𝑎𝑚 𝟷.𝟺.𝟷𝟼
│
├⍟ 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓    : <a href=https://t.me/RyanRR_Bot>⚜ Ʀ γ α и ⚜</a>
│
├⍟ 𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝑩𝒚 :  <a href=https://t.me/RhythmRockerz>𝑇𝑒𝑎𝑚 𝑅 𝑅</a>
│
╰────[<a href=https://t.me/RhythmRockerz>𝕽𝓱𝔂𝓽𝓱𝓶 ℝ𝓸𝓬𝓴𝓮𝓻𝔃</a>]────⍟"""
...
• /deletefiles - <code>Tᴏ ᴅᴇʟᴇᴛᴇ CᴀᴍRɪᴘ ᴀɴᴅ PʀᴇDVD Fɪʟᴇs ғʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>"""
    ...
    STATUS_TXT = """╭────[ 𝑺𝒕𝒂𝒕𝒊𝒔𝒕𝒊𝒄𝒔 ]────⍟
│
├⍟ 𝑻𝒐𝒕𝒂𝒍 𝑭𝒊𝒍𝒆𝒔 : <code>{}</code>
├⍟ 𝑻𝒐𝒕𝒂𝒍 𝑼𝒔𝒆𝒓𝒔 : <code>{}</code>
├⍟ 𝑻𝒐𝒕𝒂𝒍 𝑪𝒉𝒂𝒕𝒔 : <code>{}</code>
├⍟ 𝑼𝒔𝒆𝒅 𝑺𝒕𝒐𝒓𝒂𝒈𝒆 : <code>{}</code> MiB
├⍟ 𝑭𝒓𝒆𝒆 𝑺𝒕𝒐𝒓𝒂𝒈𝒆 : <code>{}</code> MiB
│
╰────[ 𝑹𝒉𝒚𝒕𝒉𝒎 𝑹𝒐𝒄𝒌𝒆𝒓𝒛 ]────⍟ """
...
‼️𝗗𝗼𝗻𝘁 𝗮𝗱𝗱 𝘄𝗼𝗿𝗱𝘀 & 𝘀𝘆𝗺𝗯𝗼𝗹𝘀 𝗹𝗶𝗸𝗲 , . -  send link movie series 𝗲𝘁𝗰‼️"""
    ...
    OWNER_INFO = """
○ 𝖢𝗋𝖾𝖺𝗍𝗈𝗋 : <a href='https://t.me/RyanRR_Bot'>𝖳𝗁𝗂𝗌 𝖯𝖾𝗋𝗌𝗈𝗇</a>
"""
...
<b>│</b> 
<b>├⍟🗃𝐹𝑖𝑙𝑒 𝑺𝒊𝒛𝒆 : <code>{file_size}</code> </b> 
<b>│</b> 
<b>╰──[𝑹𝒉𝒚𝒕𝒉𝒎 𝑹𝒐𝒄𝒌𝒆𝒓𝒛]──⍟</b>"""
...
<b>🎙 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴</b>: <code>{languages}</code>
<b>📀 𝚁𝚄𝙽𝙽𝙸𝙽𝙶 𝚃𝙸𝙼𝙴</b>: {runtime} Minutes
